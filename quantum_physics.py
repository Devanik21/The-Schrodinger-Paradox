...
def compute_local_energy(log_psi_func, r_electrons: torch.Tensor,
    ...
    # > **[Jules-Patrol Maintainer Note]:** TODO: Implement Median Absolute Deviation (MAD) filtering for robust local energy clipping.
    # The current fixed clamping is insufficient for complex systems and prone to variance explosions.
