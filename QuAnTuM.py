...
if mode == "3D Atomic VMC":
    ...
    with st.sidebar.expander("🧬 Architecture", expanded=is_big_atom):
        ...
        n_dets = st.slider("Slater Determinants", 1, 64, 8, help="Higher = More complex nodal surfaces (Fermi Voids).")
    ...
    if mode == "3D Atomic VMC" and st.session_state.solver_3d:
        ...
        if solver.energy_history:
            ...
            if system and system.exact_energy:
                ...
                # > **[Jules-Patrol Maintainer Note]:** TODO: Consider caching the exact error conversion factors for clarity
