...
class MambaBlock(nn.Module):
    ...
    def __init__(self, d_model, d_state=16, expand=2):
        ...
        # TODO: Explore alternative initialization strategies for the A_log parameter.
        # e.g., Initialization based on typical correlation length scales of the physical system.
